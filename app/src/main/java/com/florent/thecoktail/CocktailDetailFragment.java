...
public class CocktailDetailFragment extends Fragment {
    ...
    public CocktailDetailFragment(String name){
        this.name = name.replaceAll(" ", "_").toLowerCase(Locale.ROOT);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<Drink> callGetRandomTitle = webServicesInterface.getCoktailDetail(this.name);
