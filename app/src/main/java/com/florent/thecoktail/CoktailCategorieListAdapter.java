...
public class CoktailCategorieListAdapter extends RecyclerView.Adapter<CoktailCategorieCellHolder> {
    private CoktailCategorie[] dataSource;
    private OnCoktailCategorieListClickListener onCoktailCategorieListClickListener;
    public CoktailCategorieListAdapter(CoktailCategorie[] dataSource, OnCoktailCategorieListClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull CoktailCategorieCellHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onCoktailCategorieListClickListener.onCoktailCategorieListClick(dataSource[holder.getAdapterPosition()]);
            }
        });
    }
